...
<html lang="en">
  <head>
    ...
    <?php echo $__env->make('market.tpspage.css', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
  </head>
  <body>
    <nav class="navbar bg-body-tertiary bg-dark" data-bs-theme="dark">
        <div class="container-fluid">
          <a class="navbar-brand d-inline" href="#"><?php echo $cmp_logo->text; ?></a>
          <div class="navbar-brand d-inline text-end">
            <a href="" class="fs-5 nav-link nav-text"><?php echo $cmp_name->text; ?></a>
          </div>
        </div>
      </nav>
            ...
            <div class="container pt-1 pb-5">
                <div class="row sec-row-1 mt-5 pt-5">
                    <div class="col-lg-12 col-md-12 col-sm-12 text-end bg-img">
                        <h1 class="text-white sec-1-h1"><?php echo $section_1_title->text; ?></h1>
                        <a href="#sec5"><button class="btn btn-primary btn-sec-1 px-5 mt-4 py-2 fs-5"><?php echo $section_1_btn->text; ?></button></a>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="sec-2">
          <div class="row sec-row-2" style="background-color: #157C92;">
            <div class="col-lg-5 mt-lg-4">
              <h1 class="text-center mt-5 pt-lg-5 text-white"><?php echo $section_1_title->text; ?></h1>
            </div>
