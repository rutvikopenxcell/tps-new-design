<form class="needs-validation" method="POST" action="{{url('/storecookiepolicyfrontendcms'.'/'.$countrylanguage->languageculture.'?taboption=17')}}" id="answer-form" novalidate="" data-parsley-validate="" enctype="multipart/form-data">
    @csrf
