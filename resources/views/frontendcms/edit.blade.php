...
@section('content')
<?php 
$menuhome=$menuaboutus=$menuhowitwork=$menuwhyus=$menumobileapp=$menucontactus=$menusociallink=$menupartnerwithus=$menufaq=$menuprivacypolicy=$menutermandcondition=$menucookiepolicy=$menulist=$menumetacontent=$menureferafriend=$menupagetitle=$menufooter='';
                 ...
                 <div class="ibox-content"> 
                        ...
                        <div class="tab-content mt-3" id="myTabContent">
                                <div class="tab-pane fade show active">
                                     ...
                                     @include('frontendcms.edit.includefile')
                                </div>
                        </div>
