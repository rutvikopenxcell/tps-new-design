<form class="needs-validation" method="POST" action="{{url('/updatetermsandconditionfrontendcms'.'/'.$countrylanguage->languageculture.'?taboption=11')}}" id="answer-form" novalidate="" data-parsley-validate="" enctype="multipart/form-data">
    @method('put')
    @csrf
