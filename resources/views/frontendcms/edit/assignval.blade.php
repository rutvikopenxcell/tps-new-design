<?php 
$menuhome=$menuaboutus=$menuhowitwork=$menurewardssweep=$menumobileapp=$menucontactus=$menusociallink=$menupartnerwithus='';
$booleanhome=$booleanaboutus=$booleanhowitwork=$booleanrewardssweep=$booleanmobileapp=$booleancontactus=$booleansociallink=$booleanpartnerwithus='false';
if(!isset($taboption)){
$menuhome='active';
$booleanhome='true';
}else if($taboption==1){
