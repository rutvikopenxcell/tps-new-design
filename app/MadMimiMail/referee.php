...
function getrefereeemail($Dear,$name,$Yourfriend,$refername,$hasreferredyouto,$Pleaseclickthebelowlink,$poenreglink,$Toknowmoreabout,$ThanksandRegards){
                    ...
                    <table align="left" width="100%" border="0" cellpadding="0" cellspacing="0" class="mcnImageContentContainer" style="min-width:100%;">
                        <tbody><tr>
                            <td class="mcnImageContent" valign="top" style="padding-right: 9px; padding-left: 9px; padding-top: 0; padding-bottom: 0; text-align:center;">
                                        ...
                                        <img align="center" alt="" src="https://gallery.mailchimp.com/eae092dc3c6f0fabad85dc141/images/49fb2cc1-f49a-4c9a-a6ec-a1c6906bbef4.png" width="604" style="max-width:784px; padding-bottom: 0; display: inline !important; vertical-align: bottom;" class="mcnImage">
                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
                    <tbody><tr>
                        ...
                        <td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;">
                            ...
                            <h3><?php echo $Dear; ?> <?php echo $name; ?>,</h3>
                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
                    <tbody><tr>
                        ...
                        <td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;">
                            ...
                            <div style="text-align: justify;"><?php echo $Yourfriend; ?> <?php echo $refername; ?> <?php echo $hasreferredyouto; ?>.</div>

							  <div style="text-align: justify;"><?php echo $Pleaseclickthebelowlink ?>.</div>
                        </td>
                    </tr>
                </tbody></table>
				<!--[if mso]>
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" width="100%" id="templateFooter">
                                        <tr>
                                            <td align="center" valign="top">
                                                <table border="0" cellpadding="0" cellspacing="0" width="640" class="templateContainer">
                                                    <tr>
                                                        <td valign="top" class="footerContainer" style="padding-top:9px; padding-bottom:9px;"><table border="0" cellpadding="0" cellspacing="0" width="100%" class="mcnButtonBlock" style="min-width:100%;">
                    ...
                    <tbody>
                        <tr>
                            <td align="center" valign="middle" class="mcnButtonContent" style="font-family: Arial; font-size: 16px; padding: 15px;">
                                <a class="mcnButton " title="The Panelstation" href="<?php echo $poenreglink; ?>" target="_blank" style="font-weight: bold;letter-spacing: normal;line-height: 100%;text-align: center;text-decoration: none;color: #FFFFFF;">The Panelstation</a>
                            </td>
                        </tr>
                    </tbody>
                </table>
...
<span style="font-size:14px"><?php echo $Toknowmoreabout; ?>&nbsp;<a href="https://thepanelstation.com" style="color: #3d85b8;" target="blank">[[tracking_beacon]]The Panelstation</a>.<br>
<br>

<br>
<?php echo $ThanksandRegards; ?>
